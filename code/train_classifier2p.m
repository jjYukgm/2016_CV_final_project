function [ nn, labels ] = train_classifier2p( train_paths, train_labels, test_paths, test_labels, opts )
% input:
...
rand('state',0)
layer = [size(train_x, 2), 150, 48, num_categories];
nn = nnsetup(layer);
...
%   str_labels_te: n by 1 cells
    ...
    if opts_w == 1
        for i = 1:num_categories
            ...
            dou_labels_tr( strcmp(str_labels2{i}, str_labels_tr),i) = num_tot /num_categories / num_i;% to weight the tr_num
